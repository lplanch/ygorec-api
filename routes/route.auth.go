...
import (
	...
	activationAuth "github.com/lplanch/test-go-api/controllers/auth-controllers/activation"
	forgotAuth "github.com/lplanch/test-go-api/controllers/auth-controllers/forgot"
	...
	resendAuth "github.com/lplanch/test-go-api/controllers/auth-controllers/resend"
	resetAuth "github.com/lplanch/test-go-api/controllers/auth-controllers/reset"
	handlerActivation "github.com/lplanch/test-go-api/handlers/auth-handlers/activation"
	handlerForgot "github.com/lplanch/test-go-api/handlers/auth-handlers/forgot"
	handlerLogin "github.com/lplanch/test-go-api/handlers/auth-handlers/login"
	handlerRegister "github.com/lplanch/test-go-api/handlers/auth-handlers/register"
	handlerResend "github.com/lplanch/test-go-api/handlers/auth-handlers/resend"
	handlerReset "github.com/lplanch/test-go-api/handlers/auth-handlers/reset"
	"gorm.io/gorm"
)
